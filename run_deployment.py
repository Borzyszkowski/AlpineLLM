...
def parse_args():
    ...
    parser.add_argument("--model-path", required=False, default='./TRAINING_RESULTS/best_model', type=str,
...
def deploy_model(args):
    ...
    api.upload_file(
        ...
        repo_type="model",
        commit_message=f"{datetime.now().strftime('%Y%m%d_%H%M%S')} update model weights"
    )
